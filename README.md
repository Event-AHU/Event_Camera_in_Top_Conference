...
<img src="https://github.com/Event-AHU/Event_Camera_in_Top_Conference/blob/main/figures/dvs.jpg" width="800"> 
...
[[Paper](http://www.cjig.cn/jig/ch/reader/create_pdf.aspx?file_no=20220606&flag=1&year_id=2022&quarter_id=6)] 

* **Deep Learning for Event-based Vision: A Comprehensive Survey and Benchmarks**, Xu Zheng∗, Yexin Liu∗, Yunfan Lu, Tongyan Hua, Tianbo Pan, Weiming Zhang, Dacheng Tao, Lin Wang, 
...
[[Paper](https://openaccess.thecvf.com/content/WACV2023/papers/Huang_EventPoint_Self-Supervised_Interest_Point_Detection_and_Description_for_Event-Based_Camera_WACV_2023_paper.pdf)] 

* Bajestani, Seyed Ehsan Marjani, and Giovanni Beltrame. "**Event-Based RGB Sensing With Structured Light.**" Proceedings of the IEEE/CVF Winter Conference on Applications of Computer Vision. 2023. 
[[Paper](https://openaccess.thecvf.com/content/WACV2023/papers/Bajestani_Event-Based_RGB_Sensing_With_Structured_Light_WACV_2023_paper.pdf)]
...
### CVPR 2022 
* **Brain-Inspired Multilayer Perceptron With Spiking Neurons**, Wenshuo Li, Hanting Chen, Jianyuan Guo, Ziyang Zhang, Yunhe Wang; Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2022, pp. 783-793
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/html/Li_Brain-Inspired_Multilayer_Perceptron_With_Spiking_Neurons_CVPR_2022_paper.html)] 
[[Code](https://gitee.com/mindspore/models/tree/master/research/cv/snn_mlp)]


* **Optical Flow Estimation for Spiking Camera**, Liwen Hu, Rui Zhao, Ziluo Ding, Lei Ma, Boxin Shi, Ruiqin Xiong, Tiejun Huang; Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2022, pp. 17844-17853
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/papers/Hu_Optical_Flow_Estimation_for_Spiking_Camera_CVPR_2022_paper.pdf)]
[[Code](https://github.com/Acnext/Optical-Flow-For-Spiking-Camera)] 


* Schaefer, Simon, Daniel Gehrig, and Davide Scaramuzza. "**AEGNN: Asynchronous Event-based Graph Neural Networks**." Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition. 2022. 
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/html/Schaefer_AEGNN_Asynchronous_Event-Based_Graph_Neural_Networks_CVPR_2022_paper.html)] 
[[Project](https://uzh-rpg.github.io/aegnn/)]
[[Code](https://github.com/uzh-rpg/aegnn/)]

* Zhou, Xinyu, et al. "**EvUnroll: Neuromorphic Events Based Rolling Shutter Image Correction.**" Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition. 2022. 
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/html/Zhou_EvUnroll_Neuromorphic_Events_Based_Rolling_Shutter_Image_Correction_CVPR_2022_paper.html)] 
[[Code](https://github.com/zxyemo/EvUnroll)]

* Song, Chen, Qixing Huang, and Chandrajit Bajaj. "**E-CIR: Event-Enhanced Continuous Intensity Recovery.**" Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition. 2022. 
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/html/Song_E-CIR_Event-Enhanced_Continuous_Intensity_Recovery_CVPR_2022_paper.html)] 
...
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/papers/He_TimeReplayer_Unlocking_the_Potential_of_Event_Cameras_for_Video_Interpolation_CVPR_2022_paper.pdf)] 
[[Project](https://sites.google.com/view/timereplayer)]

* Zhang, Jiqing, et al. "**Spiking Transformers for Event-Based Single Object Tracking.**" Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition. 2022.
...
* Kim, Junho, Inwoo Hwang, and Young Min Kim. "**Ev-TTA: Test-Time Adaptation for Event-Based Object Recognition.**" Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition. 2022.
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/papers/Kim_Ev-TTA_Test-Time_Adaptation_for_Event-Based_Object_Recognition_CVPR_2022_paper.pdf)] 

* Nam, Yeongwoo, et al. "**Stereo Depth from Events Cameras: Concentrate and Focus on the Future.**" Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition. 2022.
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/papers/Nam_Stereo_Depth_From_Events_Cameras_Concentrate_and_Focus_on_the_CVPR_2022_paper.pdf)] 
[[Code](https://github.com/yonseivnl/se-cff)]

* Liao, Wei, et al. "**Synthetic Aperture Imaging With Events and Frames.**" Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition. 2022.
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/papers/Liao_Synthetic_Aperture_Imaging_With_Events_and_Frames_CVPR_2022_paper.pdf)] 
[[Code](https://github.com/smjsc/EF-SAI)]

* Hidalgo-Carrió, Javier, Guillermo Gallego, and Davide Scaramuzza. "**Event-aided Direct Sparse Odometry.**" Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition. 2022.
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/papers/Hidalgo-Carrio_Event-Aided_Direct_Sparse_Odometry_CVPR_2022_paper.pdf)] 
[[Code](https://rpg.ifi.uzh.ch/eds.html)]

* Zhu, Lin, et al. "**Event-based Video Reconstruction via Potential-assisted Spiking Neural Network.**" Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition. 2022.
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/papers/Zhu_Event-Based_Video_Reconstruction_via_Potential-Assisted_Spiking_Neural_Network_CVPR_2022_paper.pdf)] 
[[Project](https://sites.google.com/view/evsnn)]
[[Code](https://github.com/LinZhu111/EVSNN)]

* Tulyakov, Stepan, et al. "**Time Lens++: Event-based Frame Interpolation with Parametric Non-linear Flow and Multi-scale Fusion.**" Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition. 2022.
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/html/Tulyakov_Time_Lens_Event-Based_Frame_Interpolation_With_Parametric_Non-Linear_Flow_and_CVPR_2022_paper.html)] 
[[Project](https://uzh-rpg.github.io/timelens-pp/)]
[[Code](https://github.com/uzh-rpg/timelens-pp/)]

* **Autofocus for Event Cameras**, Shijie Lin, Yinqiang Zhang, Lei Yu, Bin Zhou, Xiaowei Luo, Jia Pan; Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2022, pp. 16344-16353
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/html/Lin_Autofocus_for_Event_Cameras_CVPR_2022_paper.html)] 
[[Project](https://eleboss.github.io/eaf_webpage/)]
[[Code](https://github.com/eleboss/eaf_code)]
[[Dataset](https://datahub.hku.hk/articles/dataset/EAF/19407884/1)] 
[[Youtube](https://www.youtube.com/watch?v=_BL80phQMW8)] 
[[Bilibili](https://www.bilibili.com/video/BV1g34y147d6)]

* **Discrete Time Convolution for Fast Event-Based Stereo**, Kaixuan Zhang, Kaiwei Che, Jianguo Zhang, Jie Cheng, Ziyang Zhang, Qinghai Guo, Luziwei Leng; Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2022, pp. 8676-8686
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/html/Zhang_Discrete_Time_Convolution_for_Fast_Event-Based_Stereo_CVPR_2022_paper.html)] 

* **A Voxel Graph CNN for Object Classification With Event Cameras**, Yongjian Deng, Hao Chen, Hai Liu, Youfu Li; Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2022, pp. 1172-1181 
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/html/Deng_A_Voxel_Graph_CNN_for_Object_Classification_With_Event_Cameras_CVPR_2022_paper.html)] 


* **Multi-Grained Spatio-Temporal Features Perceived Network for Event-Based Lip-Reading**, Ganchao Tan, Yang Wang, Han Han, Yang Cao, Feng Wu, Zheng-Jun Zha; Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2022, pp. 20094-20103
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/html/Tan_Multi-Grained_Spatio-Temporal_Features_Perceived_Network_for_Event-Based_Lip-Reading_CVPR_2022_paper.html)] 
[[Code](https://sites.google.com/view/event-based-lipreading)]
[[Dataset](https://drive.google.com/file/d/1dBEgtmctTTWJlWnuWxFtk8gfOdVVpkQ0/view)]

* **E2(GO)MOTION: Motion Augmented Event Stream for Egocentric Action Recognition**, Chiara Plizzari, Mirco Planamente, Gabriele Goletto, Marco Cannici, Emanuele Gusso, Matteo Matteucci, Barbara Caputo; Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2022, pp. 19935-19947
[[Paper](https://openaccess.thecvf.com/content/CVPR2022/papers/Plizzari_E2GOMOTION_Motion_Augmented_Event_Stream_for_Egocentric_Action_Recognition_CVPR_2022_paper.pdf)] 
[[Code](https://github.com/EgocentricVision/N-EPIC-Kitchens)]

* **Unifying Motion Deblurring and Frame Interpolation With Events**, Xiang Zhang, Lei Yu; Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2022, pp. 17765-17774
